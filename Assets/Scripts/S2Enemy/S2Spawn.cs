...
public class S2Spawn : MonoBehaviour
{
    ...
    void Start(){
        ...
        S2EnemyCount = levelManager.GetSpecial2Count();
    ...
    void FixedUpdate()
    {
        ...
        if (spawnedEnemies < S2EnemyCount && Time.time >= nextSpawnTime)
        {
